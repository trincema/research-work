...
% rxs = generateHexagonalRxArray(center_lat, center_long, 500, 10, 500, f);
...
D3 = [8 2 1 4 6 1];
P = [plotData];
axesLabels = {'Rx1', 'Rx2', 'Rx3', 'Rx4', 'Rx5', 'Rx6', 'Rx7', 'Rx8', 'Rx9', 'Rx10',...
    'Rx11', 'Rx12', 'Rx13', 'Rx14', 'Rx15', 'Rx16', 'Rx17', 'Rx18', 'Rx19', 'Rx20',...
    'Rx21', 'Rx22', 'Rx23', 'Rx24', 'Rx25'};

% Spider plot
spider_plot(P,...
    'AxesLimits', [-130, -130, -130, -130, -130, -130, -130, -130, -130, -130,...
...
function rxSitesHex = generateHexagonalRxArray(centerLat, centerLong, ...
    radius, num_points, maxAltitude, f)
    rxs = generateCircularRxArray(centerLat, centerLong, radius, 6, -1, f);
